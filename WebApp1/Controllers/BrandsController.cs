...
namespace WebApp1.Controllers
{
    public class BrandsController : Controller
    {
        ...
        public BrandsController(BigStoreContext context, IBrandHelper brandHelper)
        {
            _context = context;
        ...
        {
            if (_brandHelper.IsExistsName(brand.Name))
            {
                ModelState.AddModelError("Name", "Bu isim zaten eklenmiş");
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BigStoreContext.Brands'  is null.");
            }
            var brand = await _context.Brands.FindAsync(id);
            if (brand != null)
            {
